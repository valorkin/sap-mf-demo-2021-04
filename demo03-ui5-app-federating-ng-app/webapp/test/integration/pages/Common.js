sap.ui.define([
	...
	return Opa5.extend("com.sap.sapui5POC.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/sap/sapui5POC/test/localService/mockserver"], function (mockserver) {
